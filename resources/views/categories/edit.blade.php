                ...
                <div class="p-8">
                    <form action="{{ route('categories.update', $category) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="name" name="name" type="text" class="w-full px-4 py-3 border-gray-300 dark:border-gray-700 dark:bg-gray-900 rounded-lg focus:ring-2 focus:ring-indigo-500" :value="old('name', $category->name)" required autofocus />
